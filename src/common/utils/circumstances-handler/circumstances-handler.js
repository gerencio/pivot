...
var CircumstancesHandler = (function () {
    ...
    CircumstancesHandler.prototype.when = function (configuration, action) {
    ...
    CircumstancesHandler.prototype.needsAtLeastOneSplit = function (message) {
        return this.when(CircumstancesHandler.noSplits(), function (splits, dataSource) {
...
//# sourceMappingURL=circumstances-handler.js.map